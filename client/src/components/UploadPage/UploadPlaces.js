            ...
            {userLogged && <form>
                ...
                <div class="container">
                    <div class="searchInput">
                        <label>Địa chỉ</label>
                        <input type="text" onChange={this.addressRecommend} value={this.state.address} /><br /><br />
                        {
                            this.state.address.length > 0 &&
                            <div class="resultBox">
                                { this.state.recommendations.length >0 && this.state.recommendations.map((value, index) => (
